...
export const DocumentIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const RefreshIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const InfoIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const CheckCircleIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const ExclamationCircleIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const LinkIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const EmailIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const PhoneIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const LocationIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const UserIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
// UsersIcon - иконка группы пользователей
export const UsersIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const CalendarIcon = ({ size = 24, className = "", ...props }: IconSvgProps) => {
  return (
    <svg
      className={className}
      width={size}
...
export const CompaniesIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const SourcesIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const AnalyticsIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const DocsIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
// Иконки управления боковым меню
export const CollapseIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const ExpandIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const WarmingIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
...
export const FilterIcon = ({size = 16, width, height, ...props}: IconSvgProps) => (
  <svg
    ...
    {...props}
  >
    <g fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M9.5 14a3 3 0 1 1 0 6a3 3 0 0 1 0-6Zm5-10a3 3 0 1 0 0 6a3 3 0 0 0 0-6Z"></path><path strokeLinecap="round" d="M15 16.959h7m-13-10H2m0 10h2m18-10h-2"></path></g>
  </svg>
);
...
export const StopIcon = ({size = 24, width, height, ...props}: IconSvgProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
